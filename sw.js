const CACHE='samen-thuis-beta-v1-0-0';
const ASSETS=['./','./index.html','./styles.css','./manifest.webmanifest','./icon.svg','./js/app.js','./js/utils.js','./js/store.js','./js/prices.js','./js/sync.js','./js/importer.js'];
